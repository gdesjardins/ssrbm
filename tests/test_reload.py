...
r = pooled_ss_rbm.PooledSpikeSlabRBM(
        ...
        sp_weight={'h':0},
        sp_targ={'h':0},
        flags={'use_cd':0, 'truncated_norml': True})

rng = numpy.random.RandomState(1231)
x = rng.randint(0, 2, size=(r.batch_size, r.n_v))

info(r, 't=0')
for i in xrange(5): r.batch_train_func(x)
info(r, 't=5')
serial.save('model_serial.pkl', r)
for i in xrange(5): r.batch_train_func(x)
info(r, 't=10')
